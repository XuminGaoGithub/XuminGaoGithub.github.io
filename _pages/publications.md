...
{% if site.author.googlescholar %}
  You can also find my articles on <a href="{{site.author.googlescholar}}" class="underline-link">my Google Scholar profile</a>. 
...
<div style="display: flex; align-items: flex-start; gap: 20px; margin-bottom: 40px;">
 ...
 <div style="flex: 0 0 300px;">
  ...
  <div style="flex: 1;">
    ...
    <!-- Buttons -->
    <p style="margin: 10px 0;">
      <a href="https://www.cnki.net/KCMS/detail/detail.aspx?dbcode=CJFD&dbname=CJFDLAST2019&filename=SJSJ201908047&uniplatform=OVERSEA&v=7d893uLcWt6Ikf0FOVXgrv_SDGl8vqCV1lf89WZ1YpOwXY_1dG1JkQMUFjkpi3we" style="margin-right:15px;">📄 Full Paper</a>
